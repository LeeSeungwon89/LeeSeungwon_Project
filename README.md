...
저는 newbie 수준이므로 정리본에 쉽게 풀어쓴 표현과 구어체를 많이 사용합니다. 적절한 조사를 사용하고자 다소 길게 쓴 문장도 있습니다. 아울러 사소한 모든 것을 print()로 찍어서 가시적으로 살폈습니다.   
...
21.9.21. 자로 이전에 정리했던 서적보다 높은 난도이면서 좀 더 구체적으로 알고리즘과 모델을 설명하는 **'파이썬 라이브러리를 활용한 머신러닝'** 이라는 서적을 정리하여 업로드를 마쳤습니다. 난도가 많이 오른 터라 예상보다 시간이 오래 걸렸지만 이전보다 스스로 더욱 크게 성장하고 있다고 느꼈고, 지속적으로 떨쳐내기 어려웠던 막연한 두려움을 해소할 수 있었습니다. 무엇보다도 앞으로는 더욱 빠르고 심층적으로 머신러닝을 학습할 수 있겠다는 자신감을 얻었습니다.    

제가 공부하면서 정리한 자료는 참고만 하시되 절대로 배포하시면 안 됩니다. 반드시 해당 서적을 구입하셔서 공부하시고 제 자료는 참고만 해주시기를 부탁드립니다.

추후에는 강의 내용을 복습하여 정리한 내용을 업로드 할 예정이며, 서적 여러 권을 비교하며 공부한 내용 또한 정리하여 업로드 할 예정입니다. 난도를 차차 올리며 빌드업 하겠습니다. 딥러닝은 머신러닝 개념 공부를 마친 뒤부터 본격적으로 공부하겠습니다. 
