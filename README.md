...
현재는 이전에 정리했던 서적보다 높은 난도이면서 좀 더 구체적으로 알고리즘과 모델에 대하여 설명하는 **'파이썬 라이브러리를 활용한 머신러닝'** 이라는 서적을 정리하여 업로드 하는 중입니다. 난도가 많이 오른 터라 예상보다 시간이 오래 걸리고 있습니다. 곧 마무리 단계에 접어듭니다. 열의를 다하겠습니다.
